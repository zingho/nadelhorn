...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 09. Dez 2017 um 22:18
...
CREATE TABLE `news` (
  `ID` int(11) NOT NULL,
  `Bild` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
(10, 'images/news_10.jpg', '5 lakes walk in Zermatt', 'The compelling Five Lakes Walk takes you from Blauherd to Sunnegga, passing by five mountain lakes on the way. You will be captivated by the reflection of the Matterhorn in the waters and by the many colourful alpine flowers around the lakes. Leisee and Grünsee lakes are great spots for a refreshing dip'),
(11, 'images/news_9.jpg', 'Swiss \"Jodl\" Festival Brig', '​Yodeling, flag throwing and playing the alphorn are just as much part of Swiss tradition as cheese and chocolate. Back in the days when there were neither telephones nor any fast and convenient forms of transport, people in mountainous and impassable regions communicated with each other by means such as natural yodeling or the alphorn');
